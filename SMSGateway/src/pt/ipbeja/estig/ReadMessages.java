...
public class ReadMessages {
    ...
    public ReadMessages(String smsNumber, String comPort) {
    ...
    public void doIt() throws Exception {
        ...
        try {
            ...
            //SerialModemGateway gateway = new SerialModemGateway("modem.com1", "COM7", 9600, "ZTE", "MF632");
            SerialModemGateway gateway = new SerialModemGateway("modem.com6", this.getComPort(), 9600, "ZTE", "MF632");
            //SerialModemGateway gateway = new SerialModemGateway("modem.com45", "COM45", 115200, "HUAWEI", "E1820");
...
//            }
    ...
    public class InboundNotification implements IInboundMessageNotification {
        ...
        public void process(AGateway gateway, MessageTypes msgType, InboundMessage msg) {
            if (msgType == MessageTypes.INBOUND) {
                ...
                this.deleteInboundMessage(gateway, msg);
        ...
        private void deleteInboundMessage(AGateway gateway, InboundMessage msg) {
            try {
                // deletes inbound msg from the given gateway
                gateway.deleteMessage(msg);
    ...
    public static void main(String args[]) {
        ...
        // check if were passed 2 arguments
        if (args.length != 2) {
            System.out.println("Wrong number of arguments passed");
            System.out.println("System will exit");
        } else {
            ReadMessages app = new ReadMessages(args[0], args[1]);
            try {
                app.doIt();
            } catch (Exception e) {
                e.printStackTrace();
